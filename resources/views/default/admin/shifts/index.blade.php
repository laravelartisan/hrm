                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @foreach($shifts as  $shift)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ json_decode($shift->contents)->tues_in }}</td>
                                                <td>{{ json_decode($shift->contents)->tues_out }}</td>
                                                <td>{{ json_decode($shift->contents)->wed_in }}</td>
                                                <td>{{ json_decode($shift->contents)->wed_out }}</td>
                                                <td>{{ json_decode($shift->contents)->thurs_in }}</td>
                                                <td>{{ json_decode($shift->contents)->thurs_out }}</td>
