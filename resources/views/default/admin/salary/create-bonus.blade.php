...
{{--                    {!! formFields($createBonusForm)  !!}--}}
                        ...
                        <div class="bonus-wraper" >
                            ...
                            <div class="check-values" >
                                ...
                                {!! Form::checkbox('total',0,false,['id'=>'total','class'=>'hide-check']) !!}&nbsp;&nbsp; Total
                                {!! Form::checkbox('basic',1,false,['id'=>'basic','class'=>'hide-check']) !!}&nbsp;&nbsp; Basic


                                @foreach($salaryTypes as $salaryType)

                                    {!! Form::checkbox(snake_case($salaryType->name),$salaryType->id,false,['id'=>snake_case($salaryType->name),'class'=>'hide-check ']) !!}&nbsp;&nbsp; {{ $salaryType->name  }}
...
{{--                                {!! Form::checkbox('rent',2,false,['id'=>'home-rent','class'=>'hide-value']) !!}&nbsp;&nbsp; Home Rent--}}
                            ...
                            <div class="form-group {{ $errors->has('name')? 'has-error':'' }}">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        {!! Form::select('amount_type',['fixed'=>'fixed','percent'=>'percent'],['class'=>'form-control hide-value']) !!}
...
{{--                                {!! Form::submit('Check Attributes',['class'=>'check-attr']) !!}--}}
                        ...
                        {!! Form::submit('Save Rules',['class'=>' save-rules' ,'id'=>'save-rules']) !!}
...
//                                    console.log(JSON.parse(bonusAttributesArray[bonusAttIndex].salary_types));
                                }
...
//alert(options);
                                $("#tblData tbody").append(
                                        "<tr>"+
                                        "<td>"+ sl++ +"</td>" +
                                        "<td>"+monthNames[bonusAtt.month]+"</td>" +
                                        "<td>" +
                                        options +
                                        "</td>" +
                                        "<td>"+bonusAtt.amount+"</td>" +
                                        "<td>"+bonusAtt.amount_type+"</td>"+
                                        "<td><button class='bonus-attr-del-btn' id="+bonusAtt.id+">Delete</button></td>"+
                                        "</tr>");
                                console.log(bonusAttributesArray);
                            }
                        });
