...
//        $this->salaryRule->status_id = $request->status_id;
    ...
    public function createOvertime(OvertimeRule $overtimeRule, Request $request)
    {
        ...
        $overtimeRulesInJson = json_encode($request->except(['_token','field_name','name','amount_type','amount','status_id']));
//        dd($allowanceRulesInJson);
    ...
    public function createSalaryCut(SalaryCutRule $salaryCutRule, Request $request)
    {
        ...
        $salaryCutRulesInJson = json_encode($request->except(['_token','field_name','name','amount_type','amount','status_id']));
//        dd($allowanceRulesInJson);
